...
public class WaveListenerTest {
	...
	public void onMessage() {
		...
		assertWave("@ChatBox hey o/", "\\o", true);
	...
	private static void assertWave(String message, String response, boolean ignoreNextMentionListenerMessage) {
		...
		MentionListenerMock mentionListener = new MentionListenerMock("ChatBox");
		WaveListener listener = new WaveListener("ChatBox", 0, mentionListener);
