...
import chatbox.chat.PingableUser;
import chatbox.chat.Room;
import chatbox.chat.RoomInfo;
import chatbox.chat.RoomPermissionException;
import chatbox.chat.SplitStrategy;
import chatbox.chat.UserInfo;
import chatbox.chat.event.Event;
import chatbox.chat.event.MessageDeletedEvent;
import chatbox.chat.event.MessageEditedEvent;
import chatbox.chat.event.MessagePostedEvent;
import chatbox.chat.event.MessageStarredEvent;
import chatbox.chat.event.MessagesMovedEvent;
import chatbox.chat.event.UserEnteredEvent;
import chatbox.chat.event.UserLeftEvent;
import chatbox.util.Sleeper;
...
public class RoomTest {
	...
	public void getPingableUsers() throws Exception {
		...
		CloseableHttpClient httpClient = new MockHttpClientBuilder()
			...
			.response(200, ResponseSamples.pingableUsers()
				.user(13379, "Murali", 1501806926, 1501769526)
				.user(4258326, "ChatBox", 1501806934, 1501802068)
			.build())
		.build();
		//@formatter:on
	...
	public void getPingableUsers_bad_responses() throws Exception {
		...
		CloseableHttpClient httpClient = new MockHttpClientBuilder()
			...
			.request("GET", "https://chat.stackoverflow.com/rooms/pingable/1"	)
			.response(200, "[ {}, [1, \"User\"], [13379, \"Murali\", 1501806926, 1501769526] ]")
		.build();
		//@formatter:on
	...
	public void getUserInfo() throws Exception {
		...
		CloseableHttpClient httpClient = new MockHttpClientBuilder()
			...
			.response(200, ResponseSamples.userInfo()
				.user(13379, "Murali", "!https://i.stack.imgur.com/awces.jpg?s=128\\u0026g=1", 23145, false, true, 1501724997, 1501770855)
				.user(4258326, "ChatBox", "f5166c4602a6deaf2accdc98c89e9b82", 408, false, false, 1501769545, 1501771253)
			.build())
		.build();
		//@formatter:on
